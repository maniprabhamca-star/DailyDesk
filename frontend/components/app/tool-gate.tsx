...
export function ToolGate({ children }: { children: React.ReactNode }) {
  ...
  if (isOwner) {
    return (
      <div>
        <div className="mx-auto mb-4 flex w-fit max-w-full items-center justify-center gap-2 rounded-lg border border-amber-400/40 bg-amber-400/10 px-4 py-2 text-center text-xs font-medium text-amber-700 dark:text-amber-400">
