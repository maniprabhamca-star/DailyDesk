...
export function BrandMark({ className = 'size-8' }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden="true" focusable="false">
      ...
      <rect x="10" y="10" width="12" height="12" rx="3.5" fill="#FBBF24" />
      <rect x="10" y="26" width="12" height="12" rx="3.5" fill="#22C55E" />
      <rect x="26" y="26" width="12" height="12" rx="3.5" fill="#F87171" />
      <g transform="rotate(9 32 15)">
