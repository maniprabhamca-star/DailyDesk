      ...
      <CardContent className="p-5">
        {!file ? (
          ...
          >
            ...
            <input ref={inputRef} type="file" accept="application/pdf,.pdf" aria-label="Choose a PDF file" className="dd-file-input" onChange={(e) => { void analyze(e.target.files?.[0]); e.currentTarget.value = ''; }} />
          </div>
        ) : (
