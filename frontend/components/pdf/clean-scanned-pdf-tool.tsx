...
import { Upload, FileText, X, Loader2, WandSparkles, SlidersHorizontal } from 'lucide-react';
      ...
      <CardContent className="p-5">
        {!file ? (
          ...
          >
            ...
            <input ref={inputRef} type="file" accept="application/pdf,.pdf" aria-label="Choose a PDF file" className="dd-file-input" onChange={(e) => { void pick(e.target.files?.[0]); e.currentTarget.value = ''; }} />
          </div>
        ) : (
