  ...
  return (
    <Card>
      <CardContent className="p-5">
        ...
        <input ref={inputRef} type="file" multiple accept="application/pdf,.pdf" aria-label="Choose a PDF file" className="dd-file-input" onChange={(e) => { pick(e.target.files); e.currentTarget.value = ''; }} />
