...
export function RotateTool() {
  ...
  useFileSession('rotate', file, loadOne);
      ...
      <CardContent className="p-5">
        ...
        {batchFiles.length > 0 ? (
          ...
          >
            ...
            <input ref={inputRef} type="file" accept="application/pdf,.pdf" multiple aria-label="Choose a PDF file" className="dd-file-input" onChange={(e) => { pick(e.target.files); e.currentTarget.value = ''; }} />
          </div>
        ) : (
          <>
