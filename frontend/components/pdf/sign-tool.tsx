  ...
  return (
    <Card>
      <CardContent className="p-5">
        ...
        <input ref={sigUploadRef} type="file" accept="image/png,image/jpeg,.png,.jpg,.jpeg" className="dd-file-input" onChange={(e) => { pickSigImage(e.target.files); e.currentTarget.value = ''; }} />
        {handoffNote && (
