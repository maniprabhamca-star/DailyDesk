    ...
    <Card>
      <CardContent className="p-5">
        ...
        >
          ...
          <input ref={inputRef} type="file" accept="application/pdf" multiple aria-label="Choose a PDF file" className="dd-file-input" onChange={(e) => { addFiles(e.target.files); e.currentTarget.value = ''; }} />
        </div>
