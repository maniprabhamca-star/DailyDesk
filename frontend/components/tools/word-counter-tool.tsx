        ...
        <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              ...
              <input ref={fileRef} type="file" accept=".txt,text/plain" aria-label="Choose a text file" className="dd-file-input" onChange={(e) => { uploadTxt(e.target.files); e.currentTarget.value = ''; }} />
