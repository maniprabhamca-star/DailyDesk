    ...
    <Card>
      <CardContent className="p-5">
        ...
        >
          ...
          <input ref={inputRef} type="file" accept=".heic,.heif,image/heic,image/heif" multiple className="dd-file-input" onChange={(e) => { addFiles(e.target.files); e.currentTarget.value = ''; }} />
        </div>
