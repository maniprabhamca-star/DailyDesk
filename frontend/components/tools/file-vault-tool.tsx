    ...
    <div>
      <div className="overflow-hidden rounded-2xl border bg-card shadow-soft">
        ...
        <div className="flex flex-wrap items-center gap-2 border-b bg-muted/30 px-5 py-2.5">
          ...
          <input ref={fileInput} type="file" multiple aria-label="Choose a file" className="dd-file-input" onChange={(e) => { if (e.target.files?.length) void addFiles(e.target.files); e.target.value = ''; }} />
