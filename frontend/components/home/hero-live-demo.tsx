    ...
    <div className="mx-auto w-full max-w-[440px]">
      <div className="overflow-hidden rounded-2xl border bg-card shadow-lift">
        ...
        <div className="flex items-center gap-2 border-b bg-muted/30 px-4 py-2.5">
          <span className="flex items-center gap-1.5 text-[13px] font-semibold"><Sparkles className="size-4 text-emerald-600 dark:text-emerald-400" /> Try it — right here</span>
        ...
        <div className="p-4">
          {phase === 'idle' || phase === 'error' ? (
            <div
              ...
              className="flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-emerald-500/35 bg-emerald-500/[0.05] px-4 py-8 text-center transition-colors hover:border-emerald-500/60 hover:bg-emerald-500/[0.09]"
            >
