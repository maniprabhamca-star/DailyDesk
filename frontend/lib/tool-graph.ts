...
export const TOOLS: Record<string, Tool> = {
  ...
  '/compress-video': { href: '/compress-video', name: 'Compress video', icon: Film, blurb: 'Make a video file much smaller', moveLabel: 'Shrink the video', acceptsPdf: false,
    tile: 'from-orange-500/10 to-orange-500/0 hover:border-orange-500/40', chip: 'bg-orange-600' },
...
const NEXT: Record<string, string[]> = {
  ...
  '/compress-video': ['/video-to-gif', '/compress-pdf', '/jpg-to-pdf'],
