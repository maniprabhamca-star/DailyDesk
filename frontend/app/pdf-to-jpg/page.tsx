...
const steps = [
  ...
  'Pick the format (JPG or PNG), quality, and which pages.',
  'Click Convert — one page downloads as an image, several download as a ZIP.',
];
...
const faqs = [
  ...
  { q: 'How do I get sharper images?', a: 'Choose “High” resolution. It renders pages at a higher scale for crisper text, at the cost of larger files.' },
  { q: 'What happens with multiple pages?', a: 'A single page downloads as one image; multiple pages are bundled into a ZIP, one image per page.' },
];
