        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-3">
            ...
            <ul className="ml-4 list-disc space-y-1">
              ...
              <li>Refunds follow our <a href="/refund-policy" className="font-semibold text-primary hover:underline">Refund Policy</a> (14-day money-back guarantee) and applicable law.</li>
            </ul>
          </div>
        </div>
      </Section>
