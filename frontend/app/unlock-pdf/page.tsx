...
export const metadata: Metadata = {
  title: 'Unlock PDF — Remove a PDF Password You Know, Free | DailyDesk',
  description:
...
const faqs = [
  ...
  { q: 'Can I use the unlocked file with your other tools?', a: 'Yes — that’s half the point. Encrypted PDFs can’t be merged, compressed, or watermarked; after unlocking, “Keep moving” hands the file straight to any other DailyDesk tool.' },
];
