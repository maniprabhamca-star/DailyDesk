...
const data: AltData = {
  ...
  intro:
    'Smallpdf caps its free plan at two file tasks a day and processes everything on its servers. DiemDesk does the same everyday jobs — merge, split, compress, convert, sign — right inside your browser, with no daily limit and nothing uploaded.',
  reasons: [
    ...
    { title: 'No 2-tasks-a-day wall', body: 'Use any tool as often as you like — there’s no daily task limit and no watermark on the free plan.' },
  ...
  rows: [
    { label: 'Free plan', us: 'Every tool, no daily cap', them: '2 tasks / day' },
  ...
  faqs: [
    { q: 'Is DiemDesk really free like Smallpdf’s free plan?', a: 'It’s free during launch with no daily task limit — where Smallpdf’s free plan stops at two tasks a day. Because DiemDesk’s in-browser tools cost nothing to run, they stay free; a later Pro plan adds scale features like batch and bigger server-tool files.' },
