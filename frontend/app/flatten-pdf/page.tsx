...
const faqs = [
  ...
  { q: 'What’s the difference between the two modes?', a: '“Flatten fields & annotations” only touches the interactive parts and keeps text razor-sharp and selectable. “Lock pages as images” redraws every page as a picture, so nothing on the page can be selected, copied or edited — bigger files, maximum lock-down. If your document has no form fields and you only want that second thing, Rasterize PDF does exactly it, with greyscale and a wider choice of detail.' },
