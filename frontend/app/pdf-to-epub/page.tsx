...
const steps = [
  ...
  'We rebuild the book: headings, lists and tables from the layout, chapters from the PDF’s bookmarks or its own headings, and page one as the cover.',
...
const faqs = [
  ...
  { q: 'Are images included?', a: 'Not in this version — page one is used as the cover, but pictures inside the book aren’t carried across yet. The conversion focuses on text, headings, lists and tables, which is what makes a PDF readable on an e-reader. Image support is planned.' },
