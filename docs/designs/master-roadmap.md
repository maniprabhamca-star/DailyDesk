...
- **New work:** ~~bank fingerprinting~~ ✅ · ~~**balance-validation engine**~~ ✅ · **Tally XML writer** ← next · review-screen UI · bank SEO pages · page quota + new Stripe tier · per-bank column maps (now an *optimisation*, not a blocker).
